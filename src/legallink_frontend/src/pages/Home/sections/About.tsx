...
import fileWithCheckSvg from "../../../assets/file-with-check.svg";
...
export function About() {
  return (
    <div className="flex h-1/2 items-center justify-center gap-x-6 px-16 py-24 text-left">
      ...
      <div className="flex h-full basis-1/3 flex-col justify-start gap-y-5">
        <img src={fileWithCheckSvg} className="w-16" alt="" />
      ...
      <div className="flex h-full basis-1/3 flex-col items-end justify-end gap-y-5">
